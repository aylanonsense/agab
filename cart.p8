...
local entity_classes={
	slime={
		...
		draw=function(self)
			...
			local shadow_color=ternary(tomatoes_collected>0,2,3)
			local base_color=ternary(tomatoes_collected>0,8,11)
			local highlight_color=ternary(tomatoes_collected>0,14,7)
			pal(3,shadow_color)
			pal(11,base_color)
...
function _init()
	...
	-- 	end
	-- })
	slime=spawn_entity("slime",39+872,85-27)
...

